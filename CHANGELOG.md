# [2.184.0](https://github.com/everything-gripe/revanced-patches/compare/v2.183.0...v2.184.0) (2023-06-30)


### Bug Fixes

* **boostforreddit:** use correct options ([ec39732](https://github.com/everything-gripe/revanced-patches/commit/ec39732a05f7c4c3360b8ba42fe50fd60952e6ac))
* don't include all Litho patches, when not included ([fc69491](https://github.com/everything-gripe/revanced-patches/commit/fc69491dfe4b119d46dd3da27b556e55fe0cecfb))
* **enable-android-debugging:** remove json options ([#2497](https://github.com/everything-gripe/revanced-patches/issues/2497)) ([3e25f5f](https://github.com/everything-gripe/revanced-patches/commit/3e25f5f8df24a585dc1097aa16877841f0c6b74a))
* **googlerecorder/remove-device-restrictions:** add missing app constraint ([#2438](https://github.com/everything-gripe/revanced-patches/issues/2438)) ([d5efe26](https://github.com/everything-gripe/revanced-patches/commit/d5efe26f8959cde75dd3865ec3c2df4b05210e4a))
* **relayforreddit/change-oauth-client-id:** change client id instead of developer key ([#2508](https://github.com/everything-gripe/revanced-patches/issues/2508)) ([4befb44](https://github.com/everything-gripe/revanced-patches/commit/4befb4414638c5936f99d8d63d73c729efc773a5))
* **syncforreddit/change-oauth-client-id:** add dev edition ([#2516](https://github.com/everything-gripe/revanced-patches/issues/2516)) ([7c7294b](https://github.com/everything-gripe/revanced-patches/commit/7c7294b750f54390dd2308de63cc09545010b17f))
* **syncforreddit:** use correct overriding method signature ([#2483](https://github.com/everything-gripe/revanced-patches/issues/2483)) ([f9770cf](https://github.com/everything-gripe/revanced-patches/commit/f9770cf1babce61cd32f6ca9140103419d8d094d))
* **youtube/client-spoof:** update settings text for known side effects of spoof signature ([#2476](https://github.com/everything-gripe/revanced-patches/issues/2476)) ([6756f80](https://github.com/everything-gripe/revanced-patches/commit/6756f80e3e0c09376a1fd613d28644bdaa24da57))
* **youtube/comments:** add missing filter ([#2423](https://github.com/everything-gripe/revanced-patches/issues/2423)) ([cab04b3](https://github.com/everything-gripe/revanced-patches/commit/cab04b3a56cfc5bf00b7c6fcf6f86ab75aa5d4fd))
* **youtube/hide-album-cards:** call correct integrations method ([0dbffaa](https://github.com/everything-gripe/revanced-patches/commit/0dbffaae7d6dcb7050a9ea6e3c771839bcfdfbe1))
* **youtube:** improve patching speed ([#2514](https://github.com/everything-gripe/revanced-patches/issues/2514)) ([77bb761](https://github.com/everything-gripe/revanced-patches/commit/77bb761b0bb38613ad9d5017c881396afa471558))
* **youtube:** separate `hide-ads` to `hide-layout-components` patch ([7e0417f](https://github.com/everything-gripe/revanced-patches/commit/7e0417f6728fa7b79a9d8cbcfd3ccba484a5567d))


### Features

* added more packages ([6f2fb59](https://github.com/everything-gripe/revanced-patches/commit/6f2fb59c7b5cc58a7c9c386a42f5df7d8bceceb7))
* **boostforreddit:** add `change-oauth-client-id` patch ([3dbc4bd](https://github.com/everything-gripe/revanced-patches/commit/3dbc4bd49df1656893ef69c68550a2deb6a92cb7))
* **google-recorder:** add `remove-device-restrictions` patch ([ef96ed1](https://github.com/everything-gripe/revanced-patches/commit/ef96ed124e12091dde34124eabd8be9f2bb9280c))
* **infinityforreddit:** add `change-oauth-client-id` patch ([#2452](https://github.com/everything-gripe/revanced-patches/issues/2452)) ([9efd790](https://github.com/everything-gripe/revanced-patches/commit/9efd7904acc6dc70f45c6c0f835c839473d9205f))
* **reddit:** add `disable-screenshot-popup` patch ([#2387](https://github.com/everything-gripe/revanced-patches/issues/2387)) ([473e051](https://github.com/everything-gripe/revanced-patches/commit/473e0512314dfa9790cf83b4cfcc7505058d3a51))
* **redditisfun/change-oauth-client-id:** add compatibility for paid versions ([#2536](https://github.com/everything-gripe/revanced-patches/issues/2536)) ([e739d2f](https://github.com/everything-gripe/revanced-patches/commit/e739d2fa16bbd0125db82c0758928addbd9950c9))
* **redditisfun:** add `change-oauth-client-id` patch ([14809cd](https://github.com/everything-gripe/revanced-patches/commit/14809cd4510ad9514b4a4820187a81681669374c))
* **relayforreddit:** add `change-oauth-client-id` patch ([#2491](https://github.com/everything-gripe/revanced-patches/issues/2491)) ([fe66f40](https://github.com/everything-gripe/revanced-patches/commit/fe66f4089d6365564c8097d3c7a1bc842c343194))
* **syncforreddit:** add change-reddit-url patch ([df9342d](https://github.com/everything-gripe/revanced-patches/commit/df9342d46238dfcc86f68fdb00459b8367035532))
* **syncforreddit:** add change-reddit-url patch ([2f38cee](https://github.com/everything-gripe/revanced-patches/commit/2f38cee3c6ec21126c8595ad976f01ffdb3ee291))
* **syncforreddit:** add change-reddit-url patch ([cf93415](https://github.com/everything-gripe/revanced-patches/commit/cf93415e6aa2c7906b2cbd7624b26052dca1b7f1))
* **twitch:** 15.4.1 support ([#2462](https://github.com/everything-gripe/revanced-patches/issues/2462)) ([826ed49](https://github.com/everything-gripe/revanced-patches/commit/826ed49c7ca5a00e383b743f88f75dbfc00adb43))
* **youtube-music:** remove version compatibility constraints ([276af14](https://github.com/everything-gripe/revanced-patches/commit/276af1415a4d354c62fe6259b6559bca1fa84f08))
* **youtube/hide-layout-components:** separate hiding expandable chips and chapters ([3fb1ce9](https://github.com/everything-gripe/revanced-patches/commit/3fb1ce9f9af150b784e42aaf5b419bb123c08375))

# [2.184.0](https://github.com/efraimbart/revanced-patches/compare/v2.183.0...v2.184.0) (2023-06-30)


### Bug Fixes

* **boostforreddit:** use correct options ([ec39732](https://github.com/efraimbart/revanced-patches/commit/ec39732a05f7c4c3360b8ba42fe50fd60952e6ac))
* don't include all Litho patches, when not included ([fc69491](https://github.com/efraimbart/revanced-patches/commit/fc69491dfe4b119d46dd3da27b556e55fe0cecfb))
* **enable-android-debugging:** remove json options ([#2497](https://github.com/efraimbart/revanced-patches/issues/2497)) ([3e25f5f](https://github.com/efraimbart/revanced-patches/commit/3e25f5f8df24a585dc1097aa16877841f0c6b74a))
* **googlerecorder/remove-device-restrictions:** add missing app constraint ([#2438](https://github.com/efraimbart/revanced-patches/issues/2438)) ([d5efe26](https://github.com/efraimbart/revanced-patches/commit/d5efe26f8959cde75dd3865ec3c2df4b05210e4a))
* **relayforreddit/change-oauth-client-id:** change client id instead of developer key ([#2508](https://github.com/efraimbart/revanced-patches/issues/2508)) ([4befb44](https://github.com/efraimbart/revanced-patches/commit/4befb4414638c5936f99d8d63d73c729efc773a5))
* **syncforreddit/change-oauth-client-id:** add dev edition ([#2516](https://github.com/efraimbart/revanced-patches/issues/2516)) ([7c7294b](https://github.com/efraimbart/revanced-patches/commit/7c7294b750f54390dd2308de63cc09545010b17f))
* **syncforreddit:** use correct overriding method signature ([#2483](https://github.com/efraimbart/revanced-patches/issues/2483)) ([f9770cf](https://github.com/efraimbart/revanced-patches/commit/f9770cf1babce61cd32f6ca9140103419d8d094d))
* **youtube/client-spoof:** update settings text for known side effects of spoof signature ([#2476](https://github.com/efraimbart/revanced-patches/issues/2476)) ([6756f80](https://github.com/efraimbart/revanced-patches/commit/6756f80e3e0c09376a1fd613d28644bdaa24da57))
* **youtube/comments:** add missing filter ([#2423](https://github.com/efraimbart/revanced-patches/issues/2423)) ([cab04b3](https://github.com/efraimbart/revanced-patches/commit/cab04b3a56cfc5bf00b7c6fcf6f86ab75aa5d4fd))
* **youtube/hide-album-cards:** call correct integrations method ([0dbffaa](https://github.com/efraimbart/revanced-patches/commit/0dbffaae7d6dcb7050a9ea6e3c771839bcfdfbe1))
* **youtube:** improve patching speed ([#2514](https://github.com/efraimbart/revanced-patches/issues/2514)) ([77bb761](https://github.com/efraimbart/revanced-patches/commit/77bb761b0bb38613ad9d5017c881396afa471558))
* **youtube:** separate `hide-ads` to `hide-layout-components` patch ([7e0417f](https://github.com/efraimbart/revanced-patches/commit/7e0417f6728fa7b79a9d8cbcfd3ccba484a5567d))


### Features

* added more packages ([6f2fb59](https://github.com/efraimbart/revanced-patches/commit/6f2fb59c7b5cc58a7c9c386a42f5df7d8bceceb7))
* **boostforreddit:** add `change-oauth-client-id` patch ([3dbc4bd](https://github.com/efraimbart/revanced-patches/commit/3dbc4bd49df1656893ef69c68550a2deb6a92cb7))
* **google-recorder:** add `remove-device-restrictions` patch ([ef96ed1](https://github.com/efraimbart/revanced-patches/commit/ef96ed124e12091dde34124eabd8be9f2bb9280c))
* **infinityforreddit:** add `change-oauth-client-id` patch ([#2452](https://github.com/efraimbart/revanced-patches/issues/2452)) ([9efd790](https://github.com/efraimbart/revanced-patches/commit/9efd7904acc6dc70f45c6c0f835c839473d9205f))
* **reddit:** add `disable-screenshot-popup` patch ([#2387](https://github.com/efraimbart/revanced-patches/issues/2387)) ([473e051](https://github.com/efraimbart/revanced-patches/commit/473e0512314dfa9790cf83b4cfcc7505058d3a51))
* **redditisfun/change-oauth-client-id:** add compatibility for paid versions ([#2536](https://github.com/efraimbart/revanced-patches/issues/2536)) ([e739d2f](https://github.com/efraimbart/revanced-patches/commit/e739d2fa16bbd0125db82c0758928addbd9950c9))
* **redditisfun:** add `change-oauth-client-id` patch ([14809cd](https://github.com/efraimbart/revanced-patches/commit/14809cd4510ad9514b4a4820187a81681669374c))
* **relayforreddit:** add `change-oauth-client-id` patch ([#2491](https://github.com/efraimbart/revanced-patches/issues/2491)) ([fe66f40](https://github.com/efraimbart/revanced-patches/commit/fe66f4089d6365564c8097d3c7a1bc842c343194))
* **syncforreddit:** add change-reddit-url patch ([cf93415](https://github.com/efraimbart/revanced-patches/commit/cf93415e6aa2c7906b2cbd7624b26052dca1b7f1))
* **twitch:** 15.4.1 support ([#2462](https://github.com/efraimbart/revanced-patches/issues/2462)) ([826ed49](https://github.com/efraimbart/revanced-patches/commit/826ed49c7ca5a00e383b743f88f75dbfc00adb43))
* **youtube-music:** remove version compatibility constraints ([276af14](https://github.com/efraimbart/revanced-patches/commit/276af1415a4d354c62fe6259b6559bca1fa84f08))
* **youtube/hide-layout-components:** separate hiding expandable chips and chapters ([3fb1ce9](https://github.com/efraimbart/revanced-patches/commit/3fb1ce9f9af150b784e42aaf5b419bb123c08375))
